...
namespace UnityLabs.Slices.Games.Chess
{
    ...
    /// </summary>
    public class HexSetupTransition : Transition
    {
        [SerializeField]
        //InterfaceReference<IGameUI> boardUiRef;
        [Inject]
        IGameUI m_ChessBoardUI;// => boardUiRef.Value;
        ...
        [SerializeField]
        HexGridManager m_BoardGenerator = null;
