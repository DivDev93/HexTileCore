...
public interface IStaticEvents
{
    ...
    public Action<IGamePlayer> OnCardPlaced { get; set; }
    public Action<IGamePlayer> OnActionResolved { get; set; }
...
public class TileEventListeners : IStaticEvents
{
    ...
    public Action<IGamePlayer> m_OnCardPlaced;
    public Action<IGamePlayer> m_OnActionResolved;
    ...
    public Action<IGamePlayer> OnCardPlaced { get => m_OnCardPlaced; set => m_OnCardPlaced = value; }
    public Action<IGamePlayer> OnActionResolved { get => m_OnActionResolved; set => m_OnActionResolved = value; }
